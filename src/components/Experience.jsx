...
const Experience = () => (
  <section id="experience" className="py-20">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 className="text-3xl font-serif mb-8 animate-slide-in-left text-white">Experience</h2>
      <div className="mb-8 flex items-start gap-3 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div>
          ...
          <h3>Oct-2024 – May-2025</h3>
          <p>Contributed to coding, debugging, and cybersecurity projects using .NET Core, React.js, MySQL, and AWS, maintaining data confidentiality and applying best practices. Completed a six-month internship recognized for professionalism, teamwork, and proactive learning; tools used include Gophish and Keepnet.</p>
      ...
      <div className="mb-8 flex items-start gap-3 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
        ...
        <div>
          ...
          <h3>Feb-2024 – April-2024</h3>
          <p>Completed internship in web development, showing dedication, hard work, and strong project performance. Recognized for commitment to learning and teamwork; worked with PHP, JavaScript, HTML, CSS, and MySQL.</p>
          <div className="mt-3 flex gap-4 items-center">
      ...
      <div className="flex items-start gap-3 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
        ...
        <div>
          ...
          <h3>March-2023 – May-2023</h3>
          <p>Accurately entered and managed student, financial, and course data while ensuring integrity and confidentiality. Assisted with reports and record maintenance, developing strong attention to detail and time management skills.</p>
        </div>
      </div>
    </div>
  </section>
